...
<header>
	<nav>
		<ul>
			...
			<li id="linav"><a id="letra" href="fantasia.jsp">Fantasia</a></li>

			<li id="linav"><a id="letra" href="futbol.jsp">Futbol</a></li>


         		<li id="navlogin"><a  href="login.jsp"><img id="imglogin" alt="lol" src="imagenes/iconos/login.png"></img></a></li>
	  ...
	  <img  style="margin-top: 15px; margin-left: 20px" id="imglogo" alt="lol" src="imagenes/iconos/gamestore.png"></img> 
	
	
	
</header>

	  <img  style="margin-top: 15px; margin-left: 20px; width: 95%; height: 70%;" alt="lol" src="imagenes/iconos/gamestore.png"></img> 
...
<div class="container">
	...
	<div class="container">
		<table class="table">
			...
			<tr>
				...
				<th style="color: black; background-color: white;">Nombre del Juego</th>
	...
	<a class="btn btn-primary" href="lstPro"  >Ver Juegos</a> 
